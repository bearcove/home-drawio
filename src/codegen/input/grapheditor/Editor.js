...
Editor.menuImage =
    "data:image/svg+xml;base64,";
Editor.moveImage =
...
Editor.addImage =
    "data:image/svg+xml;base64,";
Editor.crossImage =
 ...
 *
 */
Dialog.prototype.defaultColorImage = !mxClient.IS_SVG
    ? IMAGE_PATH + "/defaultcolor.png"
    : "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAABlBMVEUAAAD///+l2Z/dAAAAKUlEQVQI1wXBMREAIAwEsHAMjJVQKZVW6U8CDpdH0QxLnLjxoqJjYvMBewMJ51TWcscAAAAASUVORK5CYII=";
...
FilenameDialog.createFileTypes = function (editorUi, nameInput, types) {
    ...
    var nameInputChanged = function (evt) {
        ...
        for (var i = 0; i < types.length; i++) {
            ...
            if (
                name.substring(name.length - ext.length - 1) == "." + ext ||
...
(function () {
    ...
    mxGraphView.prototype.validateBackgroundStyles = function (factor, cx, cy) {
        ...
        if (graph.isGridEnabled() || graph.gridVisible) {
            ...
            position =
                -Math.round(
                    phase -
                        mxUtils.mod(this.translate.x * this.scale - x0 + dx, phase) +
                        ddx * factor,
                ) +
                "px " +
                -Math.round(
                    phase -
                        mxUtils.mod(this.translate.y * this.scale - y0 + dy, phase) +
                        ddy * factor,
                ) +
                "px";
        }
    ...
    mxGraph.prototype.panGraph = function (dx, dy) {
        ...
        if (this.shiftPreview1 != null) {
            ...
            var position =
                -Math.round(
                    phase - mxUtils.mod(this.view.translate.x * this.view.scale + dx, phase),
                ) +
                "px " +
                -Math.round(
                    phase - mxUtils.mod(this.view.translate.y * this.view.scale + dy, phase),
                ) +
                "px";
            canvas.style.backgroundPosition = position;
        }
    ...
    mxPopupMenuHandler.prototype.getCellForPopupEvent = function (me) {
        ...
        while (state != null && (model.isVertex(parent) || model.isEdge(parent))) {
            ...
            if (
                temp ||
                (!selected && (this.graph.isTableCell(cell) || this.graph.isTableRow(cell)))
            ) {
                cell = parent;
            }
