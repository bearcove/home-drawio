                    ...
                    if (
                        ...
                        try {
                            ...
                            if (size.width > 0 && size.height > 0) {
                                ...
                                if (
                                    viewBox == null ||
                                    size.width * size.height < viewBox.width * viewBox.height * 0.7
                                ) {
                                    div.getElementsByTagName("svg")[0].setAttribute(
                                        "viewBox",
                                        size.x +
                                            " " +
                                            size.y +
            ...
            try {
                ...
                for (var key in styles) {
                    ...
                    if (key == "edgeStyle" && styles[key] == "elbowEdgeStyle" && dir != null) {
                        this.setCellStyles(
                            "elbow",
                            dir == mxConstants.DIRECTION_SOUTH || dir == mxConstants.DIRECTION_NOTH
                                ? "vertical"
                                : "horizontal",
                            edges,
                        );
...
Graph.prototype.selectTableRange = function (startCell, endCell) {
    ...
    if (this.isTableCell(startCell) && this.isTableCell(endCell)) {
        ...
        if (table == this.model.getParent(endRow)) {
            ...
            if (
                cells.length > 0 &&
                (cells.length > 1 || this.getSelectionCount() > 1 || !this.isCellSelected(cells[0]))
            ) {
...
Graph.prototype.fitPages = function (pageCount, ignoreHeight) {
    ...
    var scale =
        Math.floor(20 * (ignoreHeight ? sx : Math.min(sx, ch / (vcount * fmt.height) / ps))) / 20;
...
HoverIcons.prototype.createArrow = function (img, tooltip, direction) {
    ...
    mxEvent.addListener(
        ...
        mxUtils.bind(this, function (evt) {
            if (mxEvent.isMouseEvent(evt)) {
                this.fireEvent(
                    new mxEventObject("blur", "arrow", arrow, "direction", direction, "event", evt),
                );
            }
    ...
    if (this.currentState != null) {
        ...
        if (
            ...
            positionArrow(
                this.arrowUp,
                Math.round(
                    this.currentState.getCenterX() - this.triangleUp.width / 2 - this.tolerance,
                ),
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        for (var j = 0; j < cols.length; j++) {
            ...
            var head =
                ...
                mxUtils.getValue(rowStyle, mxConstants.STYLE_STROKECOLOR, mxConstants.NONE) !=
                    mxConstants.NONE;
    ...
    mxConnector.prototype.paintLine = function (c, absPts, rounded) {
        ...
        if (
            ...
            var arcSize =
                ...
                2;
            var size =
                (parseInt(mxUtils.getValue(this.style, "jumpSize", Graph.defaultJumpSize)) - 2) /
                    2 +
                this.strokewidth;
...
if (typeof mxVertexHandler !== "undefined") {
    (function () {
        ...
        mxGraphLayout.prototype.isEdgeIgnored = function (edge) {
            return (
                graphLayoutIsEdgeIgnored.apply(this, arguments) || this.graph.isEdgeIgnored(edge)
            );
        };
        ...
        Graph.prototype.createCurrentEdgeStyle = function () {
            ...
            if (this.currentEdgeStyle["orthogonalLoop"] != null) {
                ...
                style +=
                    "orthogonalLoop=" + Graph.prototype.defaultEdgeStyle["orthogonalLoop"] + ";";
            }
        ...
        Graph.prototype.getSvg = function (
            ...
            try {
                ...
                if (svgBackground != null && theme == "dark" && Editor.enableCssDarkMode) {
                ...
                imgExport.drawCellState = function (state, canvas) {
                    var graph = state.view.graph;
                    var selected =
                        lookup != null ? lookup.get(state.cell) : graph.isCellSelected(state.cell);
                    ...
                    while ((!ignoreSelection || lookup != null) && !selected && parent != null) {
                        selected =
                            lookup != null ? lookup.get(parent) : graph.isCellSelected(parent);
                ...
                var viewRoot =
                    this.view.currentRoot != null ? this.view.currentRoot : this.model.root;
            ...
            if (mxUtils.getValue(state.style, "html", "0") == "0") {
                ...
                if (mxUtils.getValue(state.style, "nl2Br", "1") == "1") {
                    ...
                    if (
                        ...
                        result =
                            result.substring(0, result.lastIndexOf("<br")) + "<div><br/></div>";
                    }
                } else {
                    result = result.replace(/\r\n/g, "").replace(/\n/g, "");
                }
            ...
            if (mxEvent.isShiftDown(me.getEvent()) && mxEvent.isAltDown(me.getEvent())) {
                ...
                return (
                    (this.currentTerminalState != null &&
                        ...
                        timeOnTarget > 2000) ||
                    ((this.currentTerminalState == null ||
                        mxUtils.getValue(this.currentTerminalState.style, "outlineConnect", "1") !=
                            "0") &&
        ...
        mxVertexHandler.prototype.redrawHandles = function () {
            ...
            if (this.state != null && this.linkHint != null) {
                ...
                this.linkHint.style.left =
                    Math.max(0, Math.round(rs.x + (rs.width - this.linkHint.clientWidth) / 2)) +
                    "px";
        ...
        mxEdgeHandler.prototype.redrawHandles = function () {
            ...
            if (this.marker != null) {
                ...
                if (this.state != null && this.linkHint != null) {
                    ...
                    this.linkHint.style.left =
                        Math.max(0, Math.round(b.x + (b.width - this.linkHint.clientWidth) / 2)) +
                        "px";
